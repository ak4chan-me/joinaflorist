    ...
    switch($_GET['action']) {
        case 'add':
                ...
                <FORM method="POST" action="?action=update">
                    ...
                    if ($hasil) {
                        ...
                        <tr>      
                            ...
                            <td><INPUT name="produk[<?php echo $key?>]" type="text"value="<?php echo $val?>" /></td>      
            ...
            echo 'Ada <strong>'.$total.'</strong> barang di keranjang<br />';
                ...
                echo "<center><strong>Tidak ada barang dikeranjang</strong><br />";
                }
                echo '<strong>'.$this->pesan.'</strong>';//menampilkan pesan kalauada
                ?></center